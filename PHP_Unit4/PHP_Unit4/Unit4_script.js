function getQuantity() {
    ...
    xmlhttp.open("GET", "Unit4_get_quantity.php?switch=" + switchType, true);
    xmlhttp.send();
};
...
function showCustomerTable(queryName, nameType) {
    if (queryName.length == 0) {
        ...
        xmlhttp.open("GET", "Unit4_get_customer_table.php?queryName=" + queryName + "&nameType=" + nameType, true);
        xmlhttp.send();
    }
};
